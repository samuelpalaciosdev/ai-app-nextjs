...
import { mcqQuestionType } from '@/lib/validations/mcqQuestion';
import { OpenEndedQuestionType } from '@/lib/validations/openEndedQuestion';
...
export async function POST(req: Request, res: Response) {
  try {
    ...
    const { data } = await axios.post(`${process.env.API_URL}/api/quiztest`, {
      amount,
      topic,
      type,
    });
